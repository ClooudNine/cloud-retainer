...
export default async function AdminNews({ params: { locale } }: { params: { locale: string } }) {
    unstable_setRequestLocale(locale);

    const allNews = await getAllNews();

    if (!allNews) {
        return <h1>News fetch error!</h1>;
    }
    ...
    return (
        ...
        >
            <div className={'relative flex items-center gap-4'}>
                ...
                <h1 className={'-ml-2.5 text-3xl'}>Админ-панель | Новости</h1>
                <Image
