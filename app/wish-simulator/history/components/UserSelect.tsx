...
export const UserSelect = ({ type }: { type: WishHistoryTypes }) => {
    ...
    return (
        <>
            ...
            <div className="z-10 absolute w-[58%] h-[6.5%] text-[#595252] text-[2vw] md:text-[1.3vw] top-[13%] left-[32%]">
                <div
                ...
                {isSelectOpen && (
                    <div className="bg-[rgba(95,101,114,0.9)] w-[150%] rounded-3xl mt-[3%] -translate-x-20 md:translate-x-0 md:w-full">
                        {Object.entries(bannerHistoryTypes).map((option) => (
                            <div
                                key={option[0]}
                                className={
                                    'px-6 py-4 rounded-full text-white text-[4vw] md:text-[1.3vw] hover:bg-[#717887]'
                                }
                                onClick={() =>
                                    selectOptionClick(option[0] as WishHistoryTypes)
                                }
                            >
                                {option[1]}
                            </div>
