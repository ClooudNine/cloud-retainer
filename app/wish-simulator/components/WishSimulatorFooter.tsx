    ...
    return (
        <footer className={"flex justify-between pb-6 z-10 px-4 md:px-8 lg:px-16"}>
            <div className={"flex flex-col h-full w-1/2 gap-2 lg:w-1/4"}>
                ...
                <div className={"h-4/5 flex flex-col gap-2 justify-between items-start md:flex-row md:items-end md:gap-4 md:h-1/2 lg:w-2/5"}>
                    <FooterButton title={"Магазин"} />
                    <FooterButton title={"Детали"} />
                    <FooterButton title={"История"} />
                </div>
            </div>
            <div className={"flex flex-col w-1/2 items-end justify-end gap-4 md:flex-row lg:w-3/5"}>
                <WishButton count={1}/>
                <WishButton count={10}/>
            </div>
        </footer>
