	...
	theme: {
		extend: {
			keyframes: {
				'wish-item-appearance': {
					...
					'100%': {
						...
						filter:
							'brightness(100%) drop-shadow(10px 22px 1px rgba(0, 0, 0, 1))'
					}
				},
				...
				'item-icon-appearance': {
					...
					'70%': {
						opacity: 1,
						filter:
							'drop-shadow(0px 0px 10px rgba(201, 192, 224, 1)) brightness(150%)'
					},
					'100%': {
						filter:
							'drop-shadow(0px 0px 0px rgba(201, 192, 224, 0)) brightness(150%)'
					}
				},
			...
			animation: {
				...
				'item-background-appearance':
					'item-background-appearance 1.3s forwards',
				'item-description-appearance':
			...
			cursor: {
				genshin: 'url("/wish-simulator/assets/genshin-cursor.cur"), default'
			}
		}
	},
	plugins: []
