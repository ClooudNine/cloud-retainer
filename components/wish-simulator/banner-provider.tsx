...
import { currentGamePhase, currentGameVersion, initialBalance, initialBannerStats } from '@/lib/constants';
                ...
                >
                    ...
                    <Link href={'/'}>
                        <CloseButton
                            ...
                            styles={'absolute top-12 right-5 size-8 xs:max-lg:top-4 lg:top-11 lg:right-8'}
                        />
                    </Link>
                    {children}
                </BannerContext.Provider>
