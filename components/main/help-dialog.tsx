    ...
    return (
        <Dialog>
            ...
            <DialogContent className={'max-w-2xl max-xs:text-2xl max-xs:pt-12 xs:max-lg:max-w-[75%]'}>
                <DialogHeader>
                    <DialogTitle className={'max-xs:text-3xl'}>{t('header')}</DialogTitle>
                    <DialogDescription className={'max-xs:text-2xl'}>{t('description')}</DialogDescription>
                </DialogHeader>
                <p className={'text-justify'}>{t('main-info')}</p>
                <h2 className={'text-green-700 text-center'}>{t('updates')}</h2>
                <h2 className={'text-destructive text-center'}>{t('links')}</h2>
                <p>
                    E-Mail:{' '}
                ...
                <h2 className={'text-destructive text-center'}>{t('greeting')}</h2>
                <h2 className={'text-destructive text-center'}>{t('disclaimer')}</h2>
                <DialogFooter>
                    <DialogClose asChild>
