        ...
        <Dialog>
            <DialogTrigger asChild>
                <Button className={'top-8 right-8 h-min gap-2 max-xs:rounded-xl max-xs:fixed'}>
                    <span className={'max-xs:hidden'}>{dictionary.help}</span>
                    <CircleHelp className={'size-12 xs:size-6'} />
                </Button>
            </DialogTrigger>
            <DialogContent
                className={'max-w-2xl max-xs:text-2xl max-xs:pt-12 xs:max-lg:max-w-[75%]'}
            >
                <DialogHeader>
                ...
                <p className={'text-justify'}>
                    ...
                    оружием, их характеристиками, советами по улучшению, опробовать свою удачу в
                    «Симуляторе молитв». В будущем будут добавлены разделы «Достижения», «События».
                </p>
                <h2 className={'text-green-700 text-center'}>
                    Все обновления будут публиковаться в новостях на самом сайте (скоро) и в
                    Telegram-канале.
                </h2>
