...
const ConfirmBannerDelete = ({banner, closeModal}: {banner: Banners | null, closeModal: () => void}) => {
    return (
    <AlertDialog open={Boolean(banner)}>
        <AlertDialogContent className={'max-w-fit'}>
            <AlertDialogHeader>
                <AlertDialogTitle>Вы уверены, что хотите удалить данный баннер?</AlertDialogTitle>
