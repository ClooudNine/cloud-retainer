...
const Cancel = ({ handler }: { handler: () => void }) => {
    ...
    return (
        <button
            ...
            onClick={handler}
        >
            <div className={'size-7 bg-[#313131] ml-2 rounded-full group-active:opacity-50'}>
                <svg fill="none" stroke="#389ddc" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <p className={'mx-auto'}>{t('wish-simulator.cancel')}</p>
        </button>
    );
};
