        ...
        <Dialog>
            ...
            <DialogContent className={'max-w-xl'}>
                ...
                <p className={'text-justify'}>
                    ...
                    собраны все необходимые для путешественников разделы. Вы можете
                    ознакомиться с персонажами и оружием (на данный момент), опробовать
                    свою удачу в «Симуляторе молитв». В будущем будут добавлены разделы
                    «Достижения», «История молитв».
                </p>
                ...
                <h2 className={'text-destructive text-center'}>
                    ...
                    Задать интересующие вопросы, указать на ошибки и предложить
                    нововведения вы можете по следующим ссылкам
                </h2>
                <p>
                    E-Mail:{' '}
                    <a
